...
import { parseWindow } from './format.js';
...
const HELP = `
  ...
  Usage
    cctrack                 Historical summary for the last 30 days
    cctrack now             What is running right now
    cctrack stats           Historical summary
    cctrack --help
